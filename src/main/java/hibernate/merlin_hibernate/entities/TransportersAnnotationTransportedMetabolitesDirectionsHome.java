...
public class TransportersAnnotationTransportedMetabolitesDirectionsHome {
    ...
    public TransportersAnnotationTransportedMetabolitesDirections merge(TransportersAnnotationTransportedMetabolitesDirections detachedInstance) {
    ...
    public TransportersAnnotationTransportedMetabolitesDirections findById( TransportersAnnotationTransportedMetabolitesDirectionsId id) {
        log.debug("getting TransportersAnnotationTransportedMetabolitesDirections instance with id: " + id);
        try {
            TransportersAnnotationTransportedMetabolitesDirections instance = entityManager.find(TransportersAnnotationTransportedMetabolitesDirections.class, id);
