...
public class TransportersAnnotationGenesHasTcdbRegistriesHome {
    ...
    public TransportersAnnotationGenesHasTcdbRegistries merge(TransportersAnnotationGenesHasTcdbRegistries detachedInstance) {
    ...
    public TransportersAnnotationGenesHasTcdbRegistries findById( TransportersAnnotationGenesHasTcdbRegistriesId id) {
        ...
        try {
            TransportersAnnotationGenesHasTcdbRegistries instance = entityManager.find(TransportersAnnotationGenesHasTcdbRegistries.class, id);
