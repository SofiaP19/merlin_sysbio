...
public class TransportersAnnotationTcdbRegistriesId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof TransportersAnnotationTcdbRegistriesId) ) return false;
		 TransportersAnnotationTcdbRegistriesId castOther = ( TransportersAnnotationTcdbRegistriesId ) other; 
         
		 return ( (this.getUniprotId()==castOther.getUniprotId()) || ( this.getUniprotId()!=null && castOther.getUniprotId()!=null && this.getUniprotId().equals(castOther.getUniprotId()) ) )
