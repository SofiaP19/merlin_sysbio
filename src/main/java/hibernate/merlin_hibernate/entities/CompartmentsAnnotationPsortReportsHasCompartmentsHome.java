...
public class CompartmentsAnnotationPsortReportsHasCompartmentsHome {
	...
	public CompartmentsAnnotationPsortReportsHasCompartments merge(
			CompartmentsAnnotationPsortReportsHasCompartments detachedInstance) {
	...
	public CompartmentsAnnotationPsortReportsHasCompartments findById(
			CompartmentsAnnotationPsortReportsHasCompartmentsId id) {
		log.debug("getting CompartmentsAnnotationPsortReportsHasCompartments instance with id: " + id);
		try {
			CompartmentsAnnotationPsortReportsHasCompartments instance = entityManager
					.find(CompartmentsAnnotationPsortReportsHasCompartments.class, id);
