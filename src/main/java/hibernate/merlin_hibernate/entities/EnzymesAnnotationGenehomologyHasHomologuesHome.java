...
public class EnzymesAnnotationGenehomologyHasHomologuesHome {
    ...
    public EnzymesAnnotationGenehomologyHasHomologues merge(EnzymesAnnotationGenehomologyHasHomologues detachedInstance) {
    ...
    public EnzymesAnnotationGenehomologyHasHomologues findById( EnzymesAnnotationGenehomologyHasHomologuesId id) {
        ...
        try {
            EnzymesAnnotationGenehomologyHasHomologues instance = entityManager.find(EnzymesAnnotationGenehomologyHasHomologues.class, id);
