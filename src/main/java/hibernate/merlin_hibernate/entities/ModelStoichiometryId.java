...
public class ModelStoichiometryId  implements java.io.Serializable {
    ...
    public ModelStoichiometryId(int idstoichiometry, int reactionIdreaction, int compoundIdcompound, int compartmentIdcompartment) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ModelStoichiometryId) ) return false;
