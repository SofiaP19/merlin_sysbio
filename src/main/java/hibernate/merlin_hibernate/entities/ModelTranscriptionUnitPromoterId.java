...
public class ModelTranscriptionUnitPromoterId  implements java.io.Serializable {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ModelTranscriptionUnitPromoterId) ) return false;
		 ModelTranscriptionUnitPromoterId castOther = ( ModelTranscriptionUnitPromoterId ) other; 
         
		 return (this.getPromoterIdpromoter()==castOther.getPromoterIdpromoter())
 && (this.getTranscriptionUnitIdtranscriptionUnit()==castOther.getTranscriptionUnitIdtranscriptionUnit());
   }
