...
public class TransportersAnnotationGenesHasMetabolitesHasTypeHome {
	...
	public TransportersAnnotationGenesHasMetabolitesHasType merge(
			TransportersAnnotationGenesHasMetabolitesHasType detachedInstance) {
	...
	public TransportersAnnotationGenesHasMetabolitesHasType findById(
			TransportersAnnotationGenesHasMetabolitesHasTypeId id) {
		log.debug("getting TransportersAnnotationGenesHasMetabolitesHasType instance with id: " + id);
		try {
			TransportersAnnotationGenesHasMetabolitesHasType instance = entityManager
					.find(TransportersAnnotationGenesHasMetabolitesHasType.class, id);
